...
export const All = b => {
  ...
  const concatAll = ms => reduce(join, All(x), ms);
  return {value, concat, concatAll, empty: _empty}
};
...
export const Any = b => {
  ...
  const concatAll = ms => reduce(join, Any(x), ms);
...
export const Sum = n => {
  ...
  const concatAll = ms => reduce(join, Sum(x), ms);
...
export const Product = n => {
  ...
  const concatAll = ms => reduce(join, Product(x), ms);
